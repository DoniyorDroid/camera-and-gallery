...
import com.example.camera_and_gallery.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnShow.setOnClickListener {
            val intent = Intent(this, ShowAllImagesActivity::class.java)
            startActivity(intent)
        }
        binding.imageFromCamera.setOnClickListener {
